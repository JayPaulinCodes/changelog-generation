...
let isColorSupported =
	...
	("FORCE_COLOR" in env ||
		...
		(require != null && (__webpack_require__(6224).isatty)(1) && env.TERM !== "dumb") ||
		"CI" in env)
...
}
{
  ...
  exports.getChalk = ({
    ...
    var _chalk;
    (_chalk = chalk) != null ? _chalk : chalk = __webpack_require__(8707);
    if (forceColor) {
...
var lib = __webpack_require__(1322);
...
const generateCodeFrame = (string, location, highlightCode = true) =>
	(0,lib/* codeFrameColumns */.rf)(string, {start: location}, {highlightCode});
